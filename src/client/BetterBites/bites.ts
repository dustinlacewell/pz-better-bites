...
export const getDmg = () => getPlayer().getBodyDamage();

export const getStats = () => getPlayer().getStats();
...
export const onPlayerUpdate = () => {
  ...
  compareParts(
    (oldPart, newPart, injury) => {
      const biteProtection = getPlayer().getBodyPartClothingDefense(
        newPart.getIndex(),
        true,
        false
      );
